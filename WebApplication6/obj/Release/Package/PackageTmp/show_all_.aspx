<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_all_.aspx.cs" Inherits="AmHospital.show_all_" %>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="test.aspx">Templates</a></li>
      ...
      <li><a href="login_test.aspx"><span class="glyphicon glyphicon-log-in">LogOut</span></a></li>
       ...
       <div class="table-wrapper-scroll-y my-custom-scrollbar">             
        ...
        <td colspan="11">
                        ...
                        <asp:Button runat="server" ID ="btndone" Text ="Save" class="btn btn-primary" OnClick="btndone_Click" />
